...
public partial class ProcessHelper : IProcessHelper
{
    ...
    public PlatformArchitecture GetCurrentProcessArchitecture()
    {
        return RuntimeInformation.ProcessArchitecture switch
        {
            ...
            Architecture.LoongArch64 => PlatformArchitecture.LoongArch64,
            (Architecture)8 => PlatformArchitecture.Ppc64le,
            (Architecture)9 => PlatformArchitecture.RiscV64,
            _ => throw new NotSupportedException($"Not expected ProcessArchitecture value: {RuntimeInformation.ProcessArchitecture}, {(int)RuntimeInformation.ProcessArchitecture}"),
        };
    }
